...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary: {
      en: "Marketing site and user panel with an Ant Design ops admin — team contribution, plus ongoing tech-side support.",
      fa: "سایت مارکتینگ و پنل کاربر با ادمین Ant Design — مشارکت تیمی، به‌علاوهٔ پشتیبانی فنی جاری.",
    },
    problem: {
  ...
  },
  {
    ...
    summary: {
      en: "Full frontend I built myself — SEO landing, Telegram/PWA panel, and Ant Design admin — plus ongoing tech-side support.",
      fa: "کل فرانت‌اند را خودم ساختم — لندینگ SEO، پنل تلگرام/PWA و ادمین Ant Design — به‌علاوهٔ پشتیبانی فنی جاری.",
    },
    problem: {
